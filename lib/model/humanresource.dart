...
class HumanResource extends Report {
  final String bentuk;
  ...
  factory HumanResource.fromJson(Map<String, dynamic> json) {
    final report = Report.fromJson(json);

    final bentuk = json['bentuk'];
    final keadaan = json['keadaan'];
